...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
    <div class="container-fluid">
        ...
        @switch($header)
            ...
            @break
            @case(4)
                href="{{ route('service.create') }}">@lang('Services')<i class="ni ni-fat-add ml-2 text-success"></i><span class="h5 text-success">@lang('(new)')</span></a>
            @break
            @case(5)
                href="{{ route('product.create') }}">@lang('Products')<i class="ni ni-fat-add ml-2 text-success"></i><span class="h5 text-success">@lang('(new)')</span></a>
            @break
            @case(6)
